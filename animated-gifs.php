...
include "header.php";
?>
    <title>GIF - <?php echo('Page ' . $page) ?></title>
    </head>
<?php
    ...
    <div id="content-holder">
        <div class="main-filter ">
            <ul class="content-type">
                ...
                <?php }
                if (allow_gifs()) { ?>
                    <li><a class="current" href="<?php echo(rootpath()) ?>/animated-gifs"><strong>Animated GIFs</strong></a>
                    </li>
                    <?php if (rss_enable() && rss_cat_enable()) { ?>
                        <li><a class="" href="<?php echo(rootpath()) ?>/rss/gifs"
            ...
            <div id="sort">
                <label>
                    ...
                    <select
                        onchange="self.location=self.location='<?php echo(rootpath()) ?>/animated-gifs.php?sort_by='+this.options[this.selectedIndex].value">
                ...
                <?php if ($_SESSION['sort_order'] == "ASC") { ?>
                    <a href="<?php echo(rootpath()) ?>/animated-gifs.php?sort_order=DESC"><img
                            src="<?php echo(rootpath()) ?>/images/arrow_up.png" title="Ascending"></a>
                <?php } else if ($_SESSION['sort_order'] == "DESC") { ?>
                    <a href="<?php echo(rootpath()) ?>/animated-gifs.php?sort_order=ASC"><img
                        ...
                        <a href="<?php echo(rootpath()) ?>/gif/<?php echo($fetch['permalink']) ?>" class="jump_stop">
                            <div style="" class="thimage">
                                <img style="width: auto;"
                                     src="<?php echo(rootpath()) ?>/uploads/thumbs/<?php echo($fetch['file']) ?>"
