...
<meta name="keywords"
      content="Submit Your GAG, 9gag clone, 9gag script, 9gag clone script, clone, script,9Gag Clone Script">
<script>
...
if (isset($_POST['title'])) {
    ...
    <div class="field">
        <label>
            <h4>Title</h4>
            <input type="text" class="text" name="title" value="<?php echo($_POST['title']) ?>"
                   maxlength="<?php echo(post_title_length()) ?>" placeholder="Enter Your Title Here."/>
        </label>
        <?php
    ...
    <div class="field">
        <label>
            ...
            <textarea placeholder="Enter upto 170 characters of description" maxlength="170" name="description"
                      style="width:480px;height:50px"><?php echo($_POST['description']) ?></textarea>
        </label>
    </div>
    ...
    <div class="field">
        <label>
            ...
            <input type="text" class="text" name="source" value="<?php echo($_POST['source']) ?>" maxlength="255"
                   placeholder="Enter source if any e.g 9gag, damnlol"/>
        </label>
    </div>
    ...
    <div id="vidblock">
        <div class="field">
            <label>
                <h4>Video URL</h4>
                <input type="text" class="text" value="<?php echo($_POST['vidurl']) ?>" name="vidurl" id="vidurl"
                       maxlength="255" placeholder="Enter Video URL e.g youtube, vimeo etc"/>
            </label>
            <?php
    ...
    <div id="picblock">
        <div class="field">
            <label>
                <h4>Picture URL</h4>
                <input type="text" class="text" value="<?php echo($_POST['picurl']) ?>" name="picurl" id="picurl"
                       maxlength="255" placeholder="Enter Picture URL or upload using Browse button below"/>
        </div>
        <div class="field">
            <label>
                <h4>Upload</h4>
            ...
            <label>
                <h4>&nbsp;</h4>
                <a onclick="document.getElementById('myfile').value='';$('#gagurl').prop('disabled',false);">
    ...
    <div class="field">
        <label>
            <h4>Tags (Optional)</h4>
            <input type="text" class="text" name="tags" value="<?php echo($_POST['tags']) ?>"
        ...
        <div class="field">
            <label>
                ...
                <img src="./libs/captcha/captcha.php" id="captcha"/><a onclick="
										document.getElementById('captcha').src='./libs/captcha/captcha.php?'+Math.random();$(this).focus();"
                                                                       id="change-image"><img src="images/refresh.png"
                                                                                              title="Refresh image"/></a>
            </label>
        </div>
        <div class="field">
            <label>
                <h4>&nbsp;</h4>
                <input type="text" style="width: auto;" class="text" name='imagecode' value="" maxlength="5"
                       placeholder="Enter Image code here from above."/>
            </label>
            <?php
    ...
    <div class="field">
        <label>
            <h4>Title</h4>
            <input type="text" class="text" name="title" value="" maxlength="<?php echo(post_title_length()) ?>"
    ...
    <div class="field">
        <label>
            <h4>Description (Optional)</h4>
            <textarea placeholder="Enter upto 170 characters of description" maxlength="170" name="description"
                      style="width:480px;height:50px"></textarea>
        </label>
    </div>
    ...
    <div class="field">
        <label>
            <h4>Source (Optional)</h4>
            <input type="text" class="text" name="source" maxlength="255"
                   placeholder="Enter source if any e.g 9gag, damnlol"/>
        </label>
    ...
    <div id="vidblock">
        <div class="field">
            <label>
                <h4>Video URL</h4>
                <input type="text" class="text" name="vidurl" id="vidurl" maxlength="255"
    ...
    <div id="picblock">
        <div class="field">
            <label>
                <h4>Picture URL</h4>
                <input type="text" class="text" name="picurl" id="picurl" maxlength="255"
                       placeholder="Enter URL or upload using Browse button below"/>
            </label>
        </div>
        <div class="field">
            <label>
    ...
    <?php if (captcha_status()) {
        ...
        <div class="field">
            <label>
                <h4>Image Code</h4>
                <img src="./libs/captcha/captcha.php" id="captcha"/><a onclick="document.getElementById('captcha').src='./libs/captcha/captcha.php?'+Math.random();$(this).focus();"
                                                                       id="change-image"><img src="images/refresh.png"
                                                                                              title="Refresh image"/></a>
            </label>
        </div>
        <div class="field">
            <label>
                <h4>&nbsp;</h4>
                <input type="text" class="text" style="width: auto;" name='imagecode' value="" maxlength="5"
                       placeholder="Enter Image code here from above."/>
            </label>
        </div>
    <?php
